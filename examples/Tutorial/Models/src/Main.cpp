...
void loadModel()
{
	...
	if (!tinyobj::LoadObj(&attrib, &shapes, &materials, &warning, &error, "res/Global/model/bunny.obj"))
	{
...
int main(int argc, char* argv[])
{
	...
	// init shaders
	shader.create();
	shader.addShader("res/models/shader/model.vert.glsl", GL_VERTEX_SHADER);
	shader.addShader("res/models/shader/model.frag.glsl", GL_FRAGMENT_SHADER);
	shader.compile();
	// init camera
